...
#define LESENSE_LCSENSE_SENSOR_CH_CONF                                                                             \
  {                                                                                                                \
    ...
    lesenseChPinExLow,       /* GPIO pin is outputting low during the excitation period. */                        \
    lesenseChPinIdleDis,     /* GPIO pin output is disabled during the idle period. */                             \
    false,                   /* Do not use alternate excitation pins for excitation. */                            \
    true,                    /* Enabled to shift results from this channel to the decoder register. */             \
    ...
    0x00U,                   /* Counter threshold has bee set to 0x00, will be set during calibration. */          \
