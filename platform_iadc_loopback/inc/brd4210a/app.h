...
#define VDAC0_PORT                vdacChPortA
#define VDAC0_PIN                 6
#define VDAC_0_BUSALLOC           ABUSALLOC
#define VDAC0_BUS_REGISTER        GPIO_ABUSALLOC_AEVEN0_VDAC0CH0
...
#define IADC0_POS_INPUT           iadcPosInputPortAPin7
#define IADC0_NEG_INPUT           iadcNegInputGnd
#define IADC0_BUSALLOC            ABUSALLOC
#define IADC0_BUS_REGISTER        GPIO_ABUSALLOC_AODD1_ADC0
