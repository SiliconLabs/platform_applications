...
/**************************************************************************//**
 * @brief
 *  Reduces brightness of 8-bit color struct
 *
 * @param[in] color
 *  RGB struct to be scaled
 *
 * @param[in] intensity_percentage
 *  Percentage to scale colors by
 *
 * @returns
 *  Scaled RGB struct
 *****************************************************************************/
...
=======
>>>>>>> fc5b3fa (last lingering style issue I think)
