 ...
 * @param qi_message Pointer to qi_message structure to be converted into stream.
 *
 ...
 *
 * @param init_descriptor Name of the static buffer as declared in C source code.
