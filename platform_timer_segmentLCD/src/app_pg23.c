...
#define BTN0_GPIO_PORT  gpioPortA
...
void GPIO_ODD_IRQHandler(void)
{
  ...
  // Interrupt triggered by PB0 (PA5) falling edge
...
void initGPIO(void)
{
  // Configure PB1(Push Button 1) as input with filter enabled
  ...
  // Configure PA5(Push Button 0) as input with filter enabled
