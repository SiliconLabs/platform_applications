...
#define IADC_INPUT_2_PORT_PIN     iadcPosInputPortAPin14;
...
#define SCANENTRYDONE_PRS_CHANNEL 1
#define SCANENTRYDONE_PORT        gpioPortB
#define SCANENTRYDONE_PIN         5

// PRS Channel 0-5 can be routed to port A/B and Channel 6-11 to port C/D
#define SINGLEDONE_PRS_CHANNEL    2
#define SINGLEDONE_PORT           gpioPortB
#define SINGLEDONE_PIN            4
