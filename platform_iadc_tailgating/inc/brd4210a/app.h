...
#define IADC_INPUT_2_PORT_PIN     iadcPosInputPortDPin2;
...
#define SCANENTRYDONE_PORT        gpioPortA
#define SCANENTRYDONE_PIN         7

// PRS Channel 0-5 can be routed to port A/B and Channel 6-11 to port C/D
#define SINGLEDONE_PRS_CHANNEL    2
#define SINGLEDONE_PORT           gpioPortA
#define SINGLEDONE_PIN            6
