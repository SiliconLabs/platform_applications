...
#define RETARGET_RX             USART_Rx                    /* Set RX to
                                                             *   USART_Rx */
#define RETARGET_TX_LOCATION    _USART_ROUTELOC0_TXLOC_LOC10 /* Location of of
                                                              *   USART TX pin
                                                              */
#define RETARGET_RX_LOCATION    _USART_ROUTELOC0_RXLOC_LOC10 /* Location of of
                                                              *   USART RX pin
                                                              */
#define RETARGET_TXPORT         gpioPortB                   /* UART transmission
                                                             *   port */
#define RETARGET_TXPIN          6                           /* UART transmission
                                                             *   pin */
#define RETARGET_RXPORT         gpioPortB                   /* UART reception
                                                             *   port */
#define RETARGET_RXPIN          7                           /* UART reception
                                                             *   pin */
#define RETARGET_USART          1                           /* Includes
                                                             *   em_usart.h */
